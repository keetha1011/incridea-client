  ...
  return (
    <Dashboard>
      <div className="flex flex-col">
        <input
          className="text-xl font-medium mt-4 w-60 rounded-2xl bg-gray-900/80 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-30 outline-none p-2 px-4"
          ...
          <div className="flex flex-col items-start rounded-3xl bg-gray-900/80 w-full h-80 mx-4 p-4 px-8">
            ...
            <div className="flex flex-row items-center justify-center gap-3 mt-4">
              <div className="flex flex-row items-center justify-center gap-4">
                ...
                <input
                  className="text-xl font-medium w-full rounded-2xl bg-slate-600 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-30 outline-none p-2 px-4 "
