...
const UserEvents: FC<{
  ...
  return (
    <section className="h-full lg:overflow-y-scroll rounded-xl border border-green-700 bg-green-700 p-3 md:p-6">
      <LeaderBoard />
      <div className="titleFont py-5 mt-4 text-center text-5xl text-white">
        My Exploration
      </div>
        ...
        {!loading &&
          ...
          events.registeredEvents.data.length !== 0 && (
            <div className="space-y-2 w-full">
              <div className="mx-auto w-full space-y-4 px-5">
