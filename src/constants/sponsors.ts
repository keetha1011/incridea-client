...
const SPONSORS: Sponsor[] = [
  {
    ...
    title: "Sponsor type",
    notCloudinary: true,
    desc: "Guided by the philosophy of ‘We Pursue Quality,’ Lotus Properties has established itself as one of Mangaluru’s leading real estate construction and property development firms. Founded in 2015 with the blessings of the almighty and Brahmashree K S Nithyananda of Veda Vijnana Mandira, Chikmagaluru, Lotus Properties has redefined the real estate landscape of the region. Spearheaded by Mr. Jithendra Kottary and Mr. Sampath Kumar Shetty, who bring over 40 years of combined experience, the company is committed to delivering high-quality residential and commercial projects.",
    websiteURL: "https://lotusproperties.co.in/",
    logo: "Lotus_Properties_Logo.jpg",
  },
  {
    name: "SL Shet Gold & Diamond House",
    title: "Core Title Sponsor for ",
