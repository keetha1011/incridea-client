...
const QuestionComp: React.FC<QuestionProps> = (props) => {
  ...
  return (
    <div key={props.id} id={props.id} className="flex pt-8 pb-3">
      <div
        className={`flex h-auto w-full flex-col items-start rounded-3xl bg-[#1b5233] py-6 px-8 ${props.questionMode === "edit" ? "border-2 border-yellow-500" : props.questionMode === "new" ? "border-2 border-emerald-700" : ""}`}
      >
