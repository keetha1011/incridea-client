...
//     <div
//       key={team.id}
//       className="relative rounded-lg text-gray-100 items-start justify-center"
//     >
//       <div>
//       <div
//           className="titleFont text-3xl font-bold text-center text-gray-200 flex items-center justify-end space-x-2"
//         >
//           <div>{solo ? idToPid(userId) : team.name}</div>
//           {!team.confirmed && !solo && team.leaderId == userId && (
//             <EditTeamModal userId={userId} team={team} />
...
//       <div className="w-full text-center flex flex-col justify-center items-right mr-2">
//         <div className="basis-1/2 flex flex-col justify-between text-right bodyFont">
//           <div className="w-full flex-grow">
//             {team?.members?.map((member: any) => (
//               <div
