...
const Inc23 = ({ imageUrls }: { imageUrls: string[] }) => {
      ...
      <div className="relative w-full h-screen bg-gray-100 overflow-hidden bg-[url('/assets/png/inc_23_bg.jpg')] bg-cover bg-center ">
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <Image
            ...
            width={54}
            height={54}
            className="cursor-pointer opacity-86 absolute bottom-[17%] left-[58%] transform translate-x-[50%] -translate-y-[69%]  sm:bottom-[14%] sm:left-[50%] sm:width-[48px] sm:height-[48px] md:width-[58px] md:height-[58px]"
